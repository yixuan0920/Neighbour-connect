<nav class="navbar navbar-expand-lg navbar-light navbar-color position-r stroke" id="navbar">
    <div class="container-fluid">
        ...
        <ul class="navbar-nav mx-auto">
            ...
            <li class="nav-item"><a class="nav-link" href="../forms/transactions.php">Transaction</a></li>

            <a class="nav-link" href="../forms/my_transaction.php">My Orders</a>
